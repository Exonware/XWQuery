...
class PathExecutor(AOperationExecutor):
    ...
    def _execute_path(self, node: Any, params: Dict, context: ExecutionContext) -> Dict:
        ...
        FUTURE: Will use xwnode graph traversal (Dijkstra, BFS, DFS).
        """
        start = params.get('start')
        end = params.get('end')
        algorithm = params.get('algorithm', 'shortest')  # shortest, all, longest
        ...
        return {
            ...
            'note': 'Will use xwnode graph algorithms (Dijkstra/BFS/DFS)'
        }
