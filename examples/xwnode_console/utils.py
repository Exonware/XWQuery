...
================================================================
  Type .help for commands | .examples for ALL 56 operations
...
def print_examples_list():
    ...
    print("""
Example Categories (use .examples [category] to filter):
  .examples              - Show ALL 56 operations (★ RECOMMENDED!)
  .examples core         - Core CRUD operations (1-6)
  .examples filtering    - Filtering operations (7-16)
  .examples aggregation  - Aggregation operations (17-25)
  .examples projection   - Projection operations (26-27)
  .examples ordering     - Ordering operations (28-29)
  .examples graph        - Graph operations (30-34)
