...
class XWQueryScriptStrategy(AQueryStrategy):
    ...
    def _get_strategy_class_fallback(self, format_name: str) -> Optional[Type[AQueryStrategy]]:
        ...
        All strategy classes should be imported at module top and registered explicitly.
        
        This method returns None for unsupported formats - proper error handling happens
        in the calling code.
        """
        # TODO: Import all strategy classes at module top and create explicit mapping
        # For now, return None for unsupported formats (proper error raised in caller)
        return None
