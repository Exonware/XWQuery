...
def test_real_xwquery_execution():
    ...
    try:
        ...
        from exonware.xwquery.runtime.executors.engine import NativeOperationsExecutionEngine
        ...
        print(f"✅ NativeOperationsExecutionEngine initialized: {type(engine).__name__}")
        # Execute REAL query
