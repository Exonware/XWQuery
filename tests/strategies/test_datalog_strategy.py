...
import pytest
pytest.importorskip("exonware.xwquery.compiler.strategies.datalog", reason="DatalogStrategy not yet implemented")
from exonware.xwquery.compiler.strategies.datalog import DatalogStrategy
