...
import pytest
pytest.importorskip("exonware.xwquery.compiler.strategies.flux", reason="FluxStrategy module not yet implemented")
from exonware.xwquery.compiler.strategies.flux import FluxStrategy
