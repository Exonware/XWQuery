...
import pytest
pytest.importorskip("exonware.xwquery.compiler.strategies.hql", reason="HqlStrategy module not yet implemented")
from exonware.xwquery.compiler.strategies.hql import HqlStrategy
