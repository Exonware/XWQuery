...
import pytest
pytest.importorskip("exonware.xwquery.compiler.strategies.partiql", reason="PartiqlStrategy module not yet implemented")
from exonware.xwquery.compiler.strategies.partiql import PartiqlStrategy
