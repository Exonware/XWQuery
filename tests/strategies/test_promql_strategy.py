...
import pytest
pytest.importorskip("exonware.xwquery.compiler.strategies.promql", reason="PromqlStrategy module not yet implemented")
from exonware.xwquery.compiler.strategies.promql import PromqlStrategy
