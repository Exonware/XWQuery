...
import pytest
# XwnodeExecutorStrategy does not exist; module has XWNodeQueryActionExecutor (executor, not strategy).
# Skip this test module until a strategy adapter exists.
pytest.skip("XwnodeExecutorStrategy not implemented (module exposes XWNodeQueryActionExecutor only)", allow_module_level=True)
...
class TestXwnodeExecutorStrategy(BaseStrategyTest):
    ...
    def strategy(self):
        ...
        return XWNodeQueryActionExecutor()
    # ==================== Query Samples ====================
