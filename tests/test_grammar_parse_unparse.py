...
import pytest
from exonware.xwquery.compiler.adapters import UniversalGrammarAdapter
...
class TestGrammarConvenience:
    ...
    def test_sql_adapter(self):
        ...
        from exonware.xwquery.compiler.adapters import SQLGrammarAdapter
    ...
    def test_graphql_adapter(self):
        ...
        from exonware.xwquery.compiler.adapters import GraphQLGrammarAdapter
    ...
    def test_cypher_adapter(self):
        ...
        from exonware.xwquery.compiler.adapters import CypherGrammarAdapter
