...
class LazyDiscovery(APackageHelper):
    ...
    def _discover_from_pyproject_toml(self) -> None:
        ...
        try:
            ...
            # auto_load_file handles TOML parsing internally
            data = auto_serializer.auto_load_file(pyproject_path, format_hint='toml')
    ...
    def _discover_from_custom_config(self) -> None:
        ...
        for config_file in config_files:
            ...
            if config_path.exists():
                try:
                    auto_serializer = AutoSerializer()
                    data = auto_serializer.auto_load_file(config_path, format_hint='json')
    ...
    def export_to_json(self, file_path: str) -> None:
        ...
        auto_serializer = AutoSerializer()
        auto_serializer.auto_save_file(data, file_path, format_hint='json', indent=2, ensure_ascii=False)
