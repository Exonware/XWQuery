...
from .manifest import get_manifest_loader
...
# Import from discovery (avoid circular import)
def get_lazy_discovery():
    """Get discovery instance."""
    from .discovery import get_lazy_discovery as _get_lazy_discovery
