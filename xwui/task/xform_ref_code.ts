// xForms.tsx - V6
// A complete, single-file representation of the xForms application UI.
...
// - This file lives in `xwui/Task/xform_ref_code.ts`.
// - It is **reference / prototype code only** for the `XWComponentForm`
//   form management system described in:
...
//   Then design a clean, reusable `XWComponentForm` API that fits XWUI’s
