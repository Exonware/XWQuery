...
>   `xwui/Task/FREELANCER_TASK_01_FORM_MANAGER.md`
> - For a working **reference prototype implementation**, see:  
>   `xwui/Task/xform_ref_code.ts` (single-file "xForms" demo UI)
...
- The **freelancer task** (`FREELANCER_TASK_01_FORM_MANAGER.md`) asks you to build `XWComponentForm` and a demo app that exercise full CRUD form flows and XWUI extended stylization.
...
- Use `FREELANCER_TASK_01_FORM_MANAGER.md` as the **authoritative source of what you must deliver** for this task (API shape, testing, demo app, and stylization requirements).